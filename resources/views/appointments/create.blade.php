<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('appointments.index') }}" class="text-purple-500 hover:text-purple-700 transition-colors">
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-[#e2d8f7] shadow-3xs rounded-[2rem] p-8">
                ...
                <div class="mb-6">
                    <h3 class="text-lg font-extrabold text-purple-950">Programar Cita Veterinaria</h3>
                    <p class="text-xs text-purple-700/60 mt-1">Se enviará un correo electrónico de confirmación automático al propietario de la mascota con los detalles de la consulta.</p>
                </div>
                ...
                <form action="{{ route('appointments.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select id="pet_id" name="pet_id" required class="w-full rounded-2xl bg-[#fcfbfe]/50 border border-[#e2d8f7] text-purple-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all font-semibold @error('pet_id') border-rose-300 @enderror">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select id="user_id" name="user_id" required class="w-full rounded-2xl bg-[#fcfbfe]/50 border border-[#e2d8f7] text-purple-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all font-semibold @error('user_id') border-rose-300 @enderror">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="scheduled_at" name="scheduled_at"
                                ...
                                required
                                class="w-full rounded-2xl bg-[#fcfbfe]/50 border border-[#e2d8f7] text-purple-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all font-semibold @error('scheduled_at') border-rose-300 @enderror">
                        ...
                        <div>
                            ...
                            <select id="reason" name="reason" required class="w-full rounded-2xl bg-[#fcfbfe]/50 border border-[#e2d8f7] text-purple-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all font-semibold @error('reason') border-rose-300 @enderror">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                ...
                                class="w-full rounded-2xl bg-[#fcfbfe]/50 border border-[#e2d8f7] text-purple-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all resize-none font-semibold @error('notes') border-rose-300 @enderror">{{ old('notes') }}</textarea>
                    ...
                    <div class="flex items-center justify-between pt-5 border-t border-[#e2d8f7]/50">
                        <a href="{{ route('appointments.index') }}" class="inline-flex items-center px-4 py-2 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200/50 font-bold text-sm rounded-2xl transition-all shadow-sm">
                            Cancelar
                        </a>
