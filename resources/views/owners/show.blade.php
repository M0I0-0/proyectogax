                ...
                <div class="space-y-4 flex-1">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4 border-t border-[#e2d8f7]">
                        <div class="space-y-0.5">
                            ...
                            <span class="text-sm font-extrabold text-purple-950">✉️ {{ $owner->email }}</span>
                        </div>
                        <div class="space-y-0.5">
                            <span class="text-xs text-purple-750 font-bold uppercase tracking-wider block">Teléfono de Contacto</span>
                            <span class="text-sm font-extrabold text-purple-950">📞 {{ $owner->phone }}</span>
                        </div>
                        <div class="space-y-0.5">
                            <span class="text-xs text-purple-750 font-bold uppercase tracking-wider block">Dirección Postal</span>
                            <span class="text-sm font-extrabold text-purple-950">📍 {{ $owner->address }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                @if($owner->pets->isEmpty())
                    <div class="bg-white rounded-[2rem] p-12 shadow-3xs border border-[#e2d8f7] text-center">
                        <div class="h-16 w-16 rounded-full bg-purple-50 text-purple-400 flex items-center justify-center text-3xl mx-auto mb-4 border border-[#e2d8f7]">🐾</div>
                            ...
                            <div class="bg-white rounded-[2rem] p-6 shadow-3xs border border-[#e2d8f7] hover:shadow-2xs hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between">
                                <div class="space-y-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        @else
                                            <div class="h-14 w-14 rounded-2xl bg-purple-50 text-purple-500 border border-[#e2d8f7] flex items-center justify-center font-bold text-2xl shadow-3xs">
                                        ...
                                        <div>
                                            ...
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-3xs font-extrabold bg-purple-50 text-purple-700 border border-[#e2d8f7] capitalize mt-0.5 shadow-3xs">
